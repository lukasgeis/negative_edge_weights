...
for _, row in log.iterrows():
    ...
    data["rate"].append(
        row["num_pot_dk"] / row["num_acc_rounds"]
    )
    data["algo"].append("DK")
    ...
    data["round"].append(row["round"])
    data["rate"].append(
        row["num_pot_bd"] / row["num_acc_rounds"]
    )
    data["algo"].append("BD")
...
if args.degree is not None:
    ...
    fig.text(0.065, 0.50, r'\textsc{Potential Updates}' "\n" r'\textsc{per Weight Update}', va="center", rotation="vertical", fontsize=17)
    ...
    fig.text(0.053, 0.50, r'\textsc{Potential Updates}' "\n" r'\textsc{per Weight Update}', va="center", rotation="vertical", fontsize=17)
