...
parser.add_argument("--node", type=bool, action=cli.BooleanOptionalAction)
...
data = data[(data["round"] == args.round) & (data.node == node)]
...
if args.graph is None:
    ...
    fig.text(0.520,-0.08, r'\textsc{ConflictLengths}', ha="center", fontsize=20)
    fig.text(0.085, 0.50, r'\textsc{Occurences}', va="center", rotation="vertical", fontsize=17)
    ...
    fig.text(0.520, 0.05, r'\textsc{ConflictLengths}', ha="center", fontsize=20)
    fig.text(0.052, 0.50, r'\textsc{Occurences}', va="center", rotation="vertical", fontsize=17)
